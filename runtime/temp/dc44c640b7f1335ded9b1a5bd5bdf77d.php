<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/system/shop_info.html";i:1571217100;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?php echo U('System/index',array('inc_type'=>'settled')); ?>" ><span>入驻设置</span></a></li>
                <li><a href="<?php echo U('System/index',array('inc_type'=>'flow')); ?>" ><span>流水设置</span></a></li>
                <li><a href="<?php echo U('System/index',array('inc_type'=>'envelopes')); ?>" ><span>红包设置</span></a></li>
