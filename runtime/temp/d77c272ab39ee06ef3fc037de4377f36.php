<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/seller/new/admin/login.html";i:1571465965;}*/ ?>
    	...
    	<div class="sller_login_warp">
            ...
            <div class="ecsc-login-container">
                ...
                <div class="login-right">
                    <div class="login-logo"><img src="http://qiniu.baoliy168.com/63eec26ff660169356a5ee07e52b9ec.png"  style="height: 36px" width="160px"/></div>
                    <div class="items">
                        ...
                        <div class="item mb30">
                            ...
                            <a href="<?php echo U('Admin/forget_pwd'); ?>" class="no_user">您忘记了密码吗?</a>
                        </div>
                        <div class="item">
