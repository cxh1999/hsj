<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./application/seller/new/service/ajax_ask_list.html";i:1491382652;}*/ ?>
<form id="op" action="<?php echo U('Service/ask_handle'); ?>" method="post">
    ...
    <table class="ncsc-default-table">
        ...
        <tbody>
        <?php if(count($comment_list) > 0): if(is_array($comment_list) || $comment_list instanceof \think\Collection): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr>
