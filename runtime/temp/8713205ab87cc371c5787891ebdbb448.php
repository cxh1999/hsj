<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/seller/new/order/ajaxindex.html";i:1573798791;}*/ ?>
  ...
  <tbody>
    ...
    <?php $goodsList = $goodsArr[$list['order_id']]; if(is_array($goodsList) || $goodsList instanceof \think\Collection): $k = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($k % 2 );++$k;if($k == 1): ?>
     	...
     	<tr>
	      <td class="bdl"></td>
	      <td class="w70">
	      <div class="ncsc-goods-thumb"><a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$good['goods_id'])); ?>" target="_blank">
