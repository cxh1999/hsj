<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index/welcome.html";i:1571817771;}*/ ?>
<html>
<head>
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody><tr>
                                ...
                                <td>众海商客门户 <?php echo $sys_info['version']; ?></td>
                                <td class="gray_bg">更新时间:</td>
                                <td>2019-10-10</td>
                            </tr>
                            <tr>
                                <td class="gray_bg">程序开发:</td>
                                <td>重庆宝砺尚善生物(集团)科技有限公司</td>
                           ...
                           <tr>
                              ...
                              <td><a href="http://www.baoliy168.com" target="_blank">宝砺官方网站</a></td>
                          </tr>
                            </tbody></table>
                    </div>
                </div>
...
<div id="footer" style="position: static; bottom: 0px;">
    <p>版权所有 © 2019-2022 重庆宝砺尚善生物(集团)科技有限公司，并保留所有权利。</p>
</div>
