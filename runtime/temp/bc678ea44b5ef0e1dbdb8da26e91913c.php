<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"./application/seller/new/store/store_decoration.html";i:1491382652;s:41:"./application/seller/new/public/head.html";i:1571331158;s:41:"./application/seller/new/public/left.html";i:1491382652;s:41:"./application/seller/new/public/foot.html";i:1573788678;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="ncsc-form-default">
  <form id="form_setting" method="post" action="">
    <dl>
      ...
      <dd>
        <label for="store_decoration_switch_on" class="mr30">
          <input id="store_decoration_switch_on" type="radio" class="radio vm mr5" name="store_decoration_switch" value="<?php echo $decoration['decoration_id']; ?>" <?php if($store['store_decoration_switch'] > 0): ?>checked<?php endif; ?>>
          是</label>
        <label for="store_decoration_switch_off">
          <input id="store_decoration_switch_off" type="radio" class="radio vm mr5" name="store_decoration_switch" value="0" <?php if($store['store_decoration_switch'] == 0): ?>checked<?php endif; ?>>
          否</label>
    ...
    <dl>
      ...
      <dd>
        <label>
          <input type="radio" name="left_bar_type" value="1" checked="checked" /> 默认
        </label>
        <label>
          <input type="radio" name="left_bar_type" value="2" />商城相关分类品牌商品推荐
        </label>
      </dd>
    </dl>
    <dl>
