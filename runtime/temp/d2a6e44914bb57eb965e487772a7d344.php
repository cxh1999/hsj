<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./application/seller/new/order/detail.html";i:1491382652;s:41:"./application/seller/new/public/head.html";i:1571331158;s:41:"./application/seller/new/public/left.html";i:1491382652;s:41:"./application/seller/new/public/foot.html";i:1573788678;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
  ...
  <div class="ncsc-order-info" style="margin-top:30px">
    ...
    <dl class="step-first current">
      ...
      <dd class="date" title="下单时间"><?php echo date('Y-m-d H:i:s',$order['add_time']); ?></dd>
    	...
    	<!-- 已经支付, 单还未发货 -->
        <dl 
        	<?php if($show_status == 2 or $show_status > 2): ?>
	    		class="current"
	    	<?php endif; ?>>
	   <dt>支付订单</dt>
      <dd class="bg"> </dd>
      ...
      <dl 
      		<?php if($show_status == 3 or $show_status > 3): ?>
	    		class="current"
	    	<?php endif; ?>>
      <dt>商家发货 </dt>
      <dd class="bg"> </dd>
    ...
    <dl 
    	<?php if($show_status == 4 or $show_status > 4): ?>
	    		class="current"
	    <?php endif; ?>>
      <dt>已收货</dt>
      <dd class="bg"> </dd>
