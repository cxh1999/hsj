<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view2/ad/adList.html";i:1571395564;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              <tr>
                ...
                <td align="center" class="">
                  <div style="text-align: center; width: 100px;"><img src="<?php echo C('qiniu.url'); ?><?php echo $vo['ad_code']; ?>" width="80px" height="45px"></div>
                </td>
                <td align="center" class="">
