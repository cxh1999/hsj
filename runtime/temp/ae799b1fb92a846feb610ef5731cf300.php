<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./template/mobile/new/cart/ajax_cart_list.html";i:1574737727;}*/ ?>
<style type="text/css">
 ...
 <?php else: ?>
	 <div class="bottom-panel" style="display:flex">
	   ...
	   <div class="right" style="margin-top:10px">
	     <input type="button" href="javascript:void();"  onclick="return selcart_submit(<?php echo $tid; ?>);" class="xm-button " value="去结算"></div>
	</div>
<?php endif; ?> 
<script type="text/javascript">
  ...
  console.log(tid);
     ...
     if (j>0)
     {
      if (tid == 0 ) {
        ...
        window.location.href="./index.php?m=Mobile&c=Cart&a=cart2&tid="+tid
      }
     }
     else
     {   
