...
<div class="Wallet">
	<ul>
	<li class="bain1"><a href="<?php echo U('Mobile/User/account'); ?>"><strong>￥<?php echo $user['user_money']; ?>元</strong><span>余额</span></a> </li>
	<li class="bain2"><strong><?php echo $user['frozen_funds']; ?></strong><span>冻结奖金</span></li>
	</ul>
...
<div class="Wallet">
	...
	<a href="<?php echo U('Mobile/User/red_packets'); ?>"><em class="Icon Icon1"></em><dl class="b"><dt>我的红包</dt><dd>查看红包</dd></dl></a>
	<a href="<?php echo U('Mobile/User/bonus_list'); ?>" ><em class="Icon Icon2"></em><dl class="b"><dt>我的奖励</dt><dd>查看奖励</dd></dl></a>
...
<div class="Wallet">
	...
	<!--<a href="<?php echo U('User/points'); ?>"><em class="Icon Icon8"></em><dl class="b"><dt>我的积分</dt><dd>&nbsp;</dd></dl></a>-->
	...
	<a href="<?php echo U('Distribut/index'); ?>"><em class="Icon Icon6"></em><dl><dt>分享收益</dt><dd>&nbsp;</dd></dl></a>
	<a href="<?php echo U('Mobile/User/notice_shopentry'); ?>"><em class="Icon Icon12"></em><dl id="notice_shopentry"><dt>店铺入驻</dt><dd>&nbsp;</dd></dl></a>
	<!-- <a href="#"><em class="Icon Icon12"><dl class="b"><dt>店铺入驻</dt><dd>&nbsp;</dd></dl></a>   -->  
