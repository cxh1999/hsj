<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/store/store_list.html";i:1571213196;s:44:"./application/admin/view2/public/layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
			...
			<div class="hDivBox">
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 50px;" class="">付款状态</div>
						</th>
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 50px;" class="">店铺状态</div>
						</th>
						<th align="center" abbr="article_time" axis="col6" class="">
						...
						<tr>
							...
							<td align="center" class="">
								<div style="text-align: center; width: 50px;">
									<?php if($vo[pay_status] == 1): ?>已付款<?php else: ?>未付款<?php endif; ?>
								</div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 50px;">
									<?php if($vo[store_state] == 0): ?>关闭<?php endif; if($vo[store_state] == 1): ?>开启<?php endif; if($vo[store_state] == 2): ?>审核中<?php endif; ?>
								</div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 50px;">
