<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/mobile/new/cart/cart4.html";i:1573976567;s:40:"./template/mobile/new/public/footer.html";i:1491382656;s:44:"./template/mobile/new/public/footer_nav.html";i:1574478042;s:42:"./template/mobile/new/public/wx_share.html";i:1491382656;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<form action="<?php echo U('Mobile/Payment/getCode'); ?>" method="post" name="cart4_form" id="cart4_form">
    <input type="hidden" name="orderSn" value="<?php echo $master_order_sn; ?>">
<div class="content_success " >
  ...
  <div class="pay-btn">
  	<input type="hidden" name="master_order_sn" value="<?php echo $master_order_sn; ?>_<?php echo $tid; ?>" />
