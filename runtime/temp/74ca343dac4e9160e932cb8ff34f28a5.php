<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./application/seller/new/service/return_list.html";i:1491382652;s:41:"./application/seller/new/public/head.html";i:1571331158;s:41:"./application/seller/new/public/left.html";i:1491382652;s:41:"./application/seller/new/public/foot.html";i:1573788678;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Service/return_list'); ?>">换货记录</a></li>
                    <li class=""><a href="<?php echo U('Service/refund_list'); ?>">退货记录</a></li>
                </ul>
            </div>
				...
				<table class="ncsc-default-table">
				    ...
				    <?php if(count($list) > 0): if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?>
				        <tr class="bd-line">
				            ...
				            <td>
				                <?php if($items[type] == 0): ?>退货<?php endif; if($items[type] == 1): ?>换货<?php endif; if($items[type] == 2): ?>维修<?php endif; ?>
				            </td>
