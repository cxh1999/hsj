...
//    ['mca'=>'home_Goods_ajax_consult','p'=>['goods_id','consult_type','p']],  // 缓存咨询静态页面 http://www.tpshop2.0.com/index.php?m=Home&c=Goods&a=ajax_consult&goods_id=142&consult_type=0&p=2
    ...
    'options' => [
         ...
         */
        'app_id' => 'wx859da478392555b3',         // AppID
        'secret' => '5036c88d1682b9ce0b4c7f0eb9ec2b05',     // AppSecret
        'token' => 'bssile1490269414',          // Token
        ...
        'payment' => [
            'mch_id' => '1511487721',
            'key' => 'VzYGev0u0M3ZJ5PbWr5obQdGWgFmyrD8',
     ...
     */
    'qiniu' => [
        'accessKey' => 'j7ReX_n5WEo4bzndCQiiVThOdJYL1Z_iG6LqYwuy',
        'secretKey' => 'Uhr4rezlsrnSkKJbxMMYiklezg1aj7nLkpC5pW0M',
        'bucket' => [
            'business',
            'appbl'
        ],
        'url' => 'http://qiniu.baoliy168.com/',
        'urlAppbl' => 'http://app.qiniu.baoliy168.com/',
        'wwwUrl' => 'http://skhcenter.baoliy168.com/'
    ],
     ...
     */
    'yuming' => [
        'url' => 'http://skhcenter.baoliy168.com/'
    ],
    ...
    'yunSms' => [
        ...
        'accountSid' => '77ea3e44d6dc277ac6a8b8d759145822',
        'authToken' => 'f001003e682eb15af50958a10bc0d873',
        'url' => 'https://open.ucpaas.com/ol/sms/sendsms',//调取地址
