...
//        $binding=M('config')->where(['id'=>117])->value('value');
//        if (empty($binding)){
//            $user = M('users')->where(['openid'=>session('user')['openid']])->count();
//            if (empty($user)){
//                session(null);
//            }
//        }
...
//        if (!empty($binding)){
//            $arrar=session('user');
//            $data = M('users')->where('openid','=',$arrar['openid'])->find();
//            if (!$data || empty($data['name'])){
//                return $this->redirect('Mobile/Baoli/index');
//            }
//            session('user',$data);
//        }
        $this->public_assign();
